...
| D1 database ID | `wrangler.toml` rad 17 | `1e935a1e-4a24-44f4-b83d-c70235b982d9` | *Ny D1-databas ID* |
| R2 bucket name | `wrangler.toml` rad 31 | `stage-images` | *Ny bucket-namn* |
...
|---|---|---|---|
| TXT | `resend._domainkey.consid.se` | *Från Resend dashboard* | DKIM |
