...
> *Skapa och hantera event genom hela dess livscykel - före, under och efter.*
...
| E1-F6 | Budget | Budgetplanering och uppföljning per event *(ej MVP)* |
...
> *Hantera inbjudna, anmälda, väntlistade och avböjda deltagare med stöd för olika kategorier.*
...
| E2-F7 | +1 / Vidarebjudan | Möjlighet för deltagare att ta med en extra gäst (+1) eller vidarebefordra sin inbjudan till annan person *(ej MVP)* |
| E2-F8 | Deltagarpreferenser | Formulär för att samla in specifika önskemål från deltagare, t.ex. matallergier, alkoholfritt, tillgänglighetsbehov *(ej MVP)* |
| E2-F9 | Kötransparens för deltagare | Deltagare kan via länk se sin aktuella plats i väntlistan *(ej MVP)* |
...
**E2-F8: Deltagarpreferenser** *(ej MVP)*
...
**E2-F9: Kötransparens för deltagare** *(ej MVP)*
...
> *Ersätta Mailchimp med egna snygga mailutskick - internt och externt - utan kostnad per mottagare.*
...
| E3-F8 | SMS-utskick | Stöd för att skicka påminnelser och bekräftelser via SMS som komplement till e-post *(ej MVP)* |
...
> *Möjlighet att skapa en enkel webbsida per event på event.consid.se.*
...
> *Hantera vem som får skapa, redigera och läsa event.*
...
> *Koppla Stage till befintliga system för att undvika dubbelarbete.*
...
| E6-F5 | Considevent-appen | Synkning med den befintliga Consid eventappen för att undvika parallella system *(ej MVP)* |
...
**E6-F5: Considevent-appen** *(ej MVP)*
...
*Kostnaderna är uppskattningar baserade på konsultmarknadens priser och avser enbart Fas 1.*
...
*Uppskattningarna förutsätter att AI (Opus 4.6) används som par-programmerare och genererar ~60-70% av koden. Mantiden avser mänsklig tid (styrning, granskning, testning, beslut). Faktisk kalenderid beror på tillgänglighet och antal personer.*
...
*Kraven har granskats från fem perspektiv: teknisk arkitektur, GDPR/juridik, UX/användbarhet, säkerhet och projektscope. Nedan sammanfattas de viktigaste insikterna och rekommendationerna.*
...
*Översikt av idéarbetet med flödesschema, "Save the date"-mallar och smarta tankar.*

![FigJam - Kreativt tänkande](Skärmavbild 2026-02-19 kl. 10.23.49.png)

## Bilaga B: Prototyp - Eventsammanfattning

*Sammanfattningsvy för ett event med händelser (Save the date, Officiell inbjudan, Väntlista, Bekräftelse).*

![Prototyp - Eventsammanfattning](Skärmavbild 2026-02-19 kl. 10.27.38.png)

## Bilaga C: Prototyp - Deltagarlista

*Deltagarvy med namn, företag, typ (Intern/Offentlig sektor/Privat sektor) och status.*

![Prototyp - Deltagarlista](Skärmavbild 2026-02-19 kl. 10.27.50.png)

## Bilaga D: Prototyp - Webbplats

*Webbplatsvy med separata sidor för eventinformation och offentlig sektor-information.*
