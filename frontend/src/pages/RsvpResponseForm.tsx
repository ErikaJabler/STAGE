...
export function RsvpResponseForm({
  info, submitting, errorMsg,
  dietaryNotes, setDietaryNotes,
  plusOneName, setPlusOneName,
  plusOneEmail, setPlusOneEmail,
  onRespond, onStartCancel,
}: ResponseFormProps) {
  return (
    <div style={s.body}>
      <h2 style={s.title}>
      ...
      {info.participant.status === 'declined' && (
        <div style={s.alreadyResponded}>
          ...
          <div style={s.buttonGroup}>
            <button onClick={() => onRespond('attending')} disabled={submitting} style={s.primaryBtn}>
      ...
      {(info.participant.status === 'invited' || info.participant.status === 'waitlisted') && (
        <>
          ...
          <div style={s.buttonGroup}>
            ...
            <button onClick={() => onRespond('declined')} disabled={submitting} style={s.secondaryBtn}>
...
export function RsvpCancelConfirm({ info, submitting, errorMsg, onCancel, onKeep }: CancelConfirmProps) {
  return (
    <div style={s.body}>
